...
class ClienteController extends Controller
{
    ...
    public function show(cliente $cliente) {
        ...
        $vendas = venda::where('cliente_id', $cliente->id)->where('user_id', auth()->user()->id)->get();
    ...
    public function showCustom(Request $request) {
        ...
        $vendas = venda::where('cliente_id', $request->input('id-cliente'))->where('user_id', auth()->user()->id)->get();
    ...
    public function ConsultaDevedores() {
        $clientes = Cliente::where('saldo', '>' , 0 )->where('user_id', auth()->user()->id)->orderBy('nome', 'ASC')->get();
        return view('clientes', ['clientes' => $clientes]);
    }
